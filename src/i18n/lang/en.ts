...
export default {
	router: {
		...
		presentation: 'tool requisition operation',
		...
		presentationSearch: 'tool request for enquiry',
		maintenanceManage: 'repair manage',
		...
		maintenanceWarehouse:'maintenance warehousing',
		returnTools:'return the tools',
		scrapManage:'scrap management',
