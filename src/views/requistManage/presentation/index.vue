...
const state = reactive<EmptyObjectType>({
	tableData: {
		...
		header: [
			...
			{ key: 'nameCh', colWidth: '', title: '品名-中文', type: 'text', isCheck: true, isRequired: false },
			{ key: 'nameEn', colWidth: '', title: '品名-英文', type: 'text', isCheck: true, isRequired: false },
			{ key: 'drawNo', colWidth: '', title: '圖紙編號', type: 'text', isCheck: true, isRequired: false },
			{
				key: 'machineType',
				colWidth: '150',
				title: '機種',
