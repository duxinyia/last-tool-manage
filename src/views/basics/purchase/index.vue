...
const state = reactive<TableDemoState>({
	tableData: {
		...
		search: [
			{ label: 'message.pages.workno', prop: 'userid', required: false, type: 'input' },
			{ label: 'message.pages.name', prop: 'username', required: false, type: 'input' },
		],
		searchConfig: {
			isSearchBtn: true,
		},
