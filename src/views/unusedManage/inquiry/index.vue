...
const state = reactive<TableDemoState>({
	tableData: {
		...
		// 表头内容（必传，注意格式）
		header: [
			{ key: 'repairNo', colWidth: '', title: '闲置单号', type: 'text', isCheck: true },
			{ key: 'prNo', colWidth: '', title: '闲置时间', type: 'text', isCheck: true },
		...
		search: [
			{ label: '闲置单号', prop: 'repairNo', required: false, type: 'input' },
			{ label: '闲置时间', prop: 'prNo', required: false, type: 'dateRange' },
		],
		searchConfig: {
			isSearchBtn: true,
		},
