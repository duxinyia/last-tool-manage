...
<script setup lang="ts" name="idleList">
import { defineAsyncComponent, reactive, ref, onMounted } from 'vue';
import { getQueryIdleInventoryApi } from '/@/api/reports/idleList';
...
const getTableData = async () => {
	...
	data = {
		...form,
		startIdleDate: form.idleDate && form.idleDate[0],
		endIdelDate: form.idleDate && form.idleDate[1],
		page: state.tableData.page,
	};
	delete data.idleDate;
	const res = await getQueryIdleInventoryApi(data);
