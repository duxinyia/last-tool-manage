...
const state = reactive<TableDemoState>({
	tableData: {
		...
		header: [
			...
			{ key: 'outStorageType', colWidth: '', title: '转出仓库类型', type: 'text', isCheck: true },
			{ key: 'outSLocation', colWidth: '', title: '转出仓库位置', type: 'text', isCheck: true },
			{ key: 'outdate', colWidth: '', title: '转出日期', type: 'text', isCheck: true },
			{ key: 'inStorageType', colWidth: '', title: '接收仓库类型', type: 'text', isCheck: true },
			{ key: 'inSLocation', colWidth: '', title: '接收仓库位置', type: 'text', isCheck: true },
			{ key: 'transferqty', colWidth: '', title: '转移总数量', type: 'text', isCheck: true },
			{ key: 'qrqty', colWidth: '', title: '有码数量', type: 'text', isCheck: true },
			{ key: 'notqrqty', colWidth: '', title: '无码数量', type: 'text', isCheck: true },
		...
		search: [{ label: '料号', prop: 'matNo', required: false, type: 'input' }],
		searchConfig: {
			isSearchBtn: true,
		},
		// 弹窗表单
		dialogConfig: [
			...
			{ label: '转出仓库类型', prop: 'outStorageType', placeholder: '', required: false, type: 'text' },
			{ label: '转出仓库位置', prop: 'outSLocation', placeholder: '', required: false, type: 'text' },
			{ label: '转出日期', prop: 'outdate', placeholder: '', required: false, type: 'text' },
			{ label: '接收仓库类型', prop: 'inStorageType', placeholder: '', required: false, type: 'text' },
			{ label: '接收仓库位置', prop: 'inSLocation', placeholder: '', required: false, type: 'text' },
			{ label: '转移总数量', prop: 'transferqty', placeholder: '', required: false, type: 'text' },
			{ label: '有码数量', prop: 'qrqty', placeholder: '', required: false, type: 'text' },
			{ label: '无码数量', prop: 'notqrqty', placeholder: '', required: false, type: 'text' },
			{ label: '描述说明', prop: 'describe', placeholder: '', required: false, type: 'text', xs: 24, sm: 24, md: 24, lg: 24, xl: 24 },
