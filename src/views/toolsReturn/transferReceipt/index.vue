...
const state = reactive<TableDemoState>({
	tableData: {
		...
		header: [
			...
			{ key: 'outstoragename', colWidth: '', title: '转出仓库名', type: 'text', isCheck: true },
			{ key: 'outdate', colWidth: '', title: '转出日期', type: 'text', isCheck: true },
			{ key: 'instoragename', colWidth: '', title: '接收仓库名', type: 'text', isCheck: true },
		...
		dialogConfig: [
			...
			{ label: '转出仓库名', prop: 'outstoragename', placeholder: '', required: false, type: 'text' },
			{ label: '转出日期', prop: 'outdate', placeholder: '', required: false, type: 'text' },
			{ label: '接收仓库名', prop: 'instoragename', placeholder: '', required: false, type: 'text' },
